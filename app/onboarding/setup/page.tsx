    ...
    <div className="min-h-screen flex items-center justify-center p-4"
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="flex flex-col items-center mb-8">
          <Logo size={48} />
          <p className="text-sm mt-3" style={{ color: "var(--muted)" }}>Настройка AD Pulse</p>
        </div>
              ...
              <div className="space-y-4">
                <div className="flex gap-2">
                  ...
                  <select
                    ...
                    style={{ background: "var(--surface-2)", border: "1px solid var(--border-strong)", color: "var(--text)", minWidth: "80px" }}
                  >
                ...
                <button
                  ...
                  style={{ background: "var(--surface-2)", color: "var(--accent)", border: "1px solid var(--border-strong)" }}
                >
              ...
              <div className="space-y-4">
                <div className="rounded-xl p-4 space-y-3" style={{ background: "var(--surface-2)", border: "1px solid var(--border-strong)" }}>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold" style={{ color: "var(--text)" }}>Wazzup интеграция</p>
                  ...
                  <div className="space-y-2 pt-2" style={{ borderTop: "1px solid var(--border-strong)" }}>
                    {["Парсит входящие сообщения", "Создаёт транзакции автоматически", "Отправляет алерты в Telegram"].map((feat) => (
                      <div key={feat} className="flex items-center gap-2">
                        <svg className="w-3.5 h-3.5 shrink-0" style={{ color: "var(--accent)" }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                        </svg>
                        <span className="text-xs" style={{ color: "var(--muted)" }}>{feat}</span>
                      </div>
                    ))}
                  </div>
                </div>
